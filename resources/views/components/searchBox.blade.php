...
<div id="searchForm" class="ml-5">
  ...
  <div class="form-group">
    <div id="templateBox[0]" class="templateBox">
      <div class="form-inline" style="padding-bottom:5px">
        <input type="text" id='search' name="search[0]" class="form-control search w-50" placeholder="検索語句追加">
  ...
  <div class="form-group">
    <div class ="form-inline">
      ...
      <input type="submit" class="btn w-25 ml-5" value="検索実行" style="margin-right:50px;">
    </div>
  </div>
</div>
